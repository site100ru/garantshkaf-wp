        ...
        <div class="col py-5">
            ...
            <div class="row pb-2 align-items-center advantage-section mb-3 mb-xl-5">
                <div class="col-md-6 col-xl-3 mb-3 mb-xl-0">
                    <div class="row align-items-center">
                        <div class="col-2 col-xl-3">
                            <img class="w-100" style="max-width: 60px" src="<?php echo get_template_directory_uri(); ?>/img/ico/home-advantage-1.svg">
                        </div>
                ...
                <div class="col-md-6 col-xl-3 mb-3 mb-xl-0">
                    <div class="row align-items-center">
                        <div class="col-2 col-xl-3">
                            <img class="w-100" style="max-width: 60px" src="<?php echo get_template_directory_uri(); ?>/img/ico/home-advantage-2.svg">
                        </div>
                        <div class="col-10 col-md-9">
                ...
                <div class="col-md-6 col-xl-3 mb-3 mb-xl-0">
                    <div class="row align-items-center">
                        <div class="col-2 col-xl-3">
                            <img class="w-100" style="max-width: 60px" src="<?php echo get_template_directory_uri(); ?>/img/ico/home-advantage-3.svg">
                        </div>
                        <div class="col-10 col-md-9">
                ...
                <div class="col-md-6 col-xl-3  mb-3 mb-xl-0">
                    <div class="row align-items-center">
                        <div class="col-2 col-xl-3">
                            <img class="w-100" style="max-width: 60px" src="<?php echo get_template_directory_uri(); ?>/img/ico/home-advantage-4.svg">
                        </div>
                        <div class="col-10 col-md-9">
				...
				<div class="col-12 col-md-6 mb-3 mb-md-0 section-image order-1 order-md-0">
					<div class="single-image-wrapper">
						<div class="approximation img-wrapper position-relative gallery-2691">
							<img src="<?php echo get_template_directory_uri(); ?>/img/card/action-card.webp"
								class="d-block w-100 single-product-img rounded-large" loading="lazy"
								alt="Скидка до 25%. Акция до 28 февраля">
						</div>
					</div>
				</div>
