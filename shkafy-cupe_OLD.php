			...
			<div class="col-md-8 offset-md-2">
				...
				<div class="row justify-content-center">
					<div class="col-12" id="2-2">
						<h5 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">1/6</span>Какой тип шкафа Вам нужен?
						</h5>
						<div class="row justify-content-md-center mb-5">
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Корпусный</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Встроенный</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Угловой</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Радиусный</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Гардеробный</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Пока не знаю</h5>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col text-center" style="margin-top: 35px;">
								...
								<input type="button" value="Далее" class="btn btn-danger" onclick="nextQuostion( '2-2' );">
							</div>
						</div>
					</div>

					<div class="col-12" id="3-2" style="display: none;">
						<h5 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">2/6</span>Какой материал фасада
							шкафа Вы хотите?</h5>
						<div class="row justify-content-md-center mb-5">
							<div class="col-6 col-md-2">
							...
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Пескоструй</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Зеркало</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Фотопечать</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Комбинированный</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Пока не знаю, нужна консультация</h5>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col text-center" style="margin-top: 35px;">
								<input type="button" value="Назад" class="btn btn-corporate-color-outline-1"
									onclick="previousQuostion( '3-2' );">
								<input type="button" value="Далее" class="btn btn-danger" onclick="nextQuostion( '3-2' );">
							</div>
						</div>
					</div>

					<div class="col-12" id="4-2" style="display: none;">
						<h5 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">3/6</span>Какая ориентировочная
							ширина шкафа планируется?</h5>
						<div class="row justify-content-md-center mb-5">
							<div class="col-3 col-md-1">
								<label class="option_item mb-3" for="answer-4-2-1">
									...
									<div class="option_inner">
										...
										<img src="<?php echo get_template_directory_uri(); ?>/img/quiz-new/ico/check-background.svg"
											style="width: 100%;">
									</div>
								</label>
								<h5 class="mb-3 mb-md-0">1 м</h5>
							</div>
							<div class="col-3 col-md-1">
							...
							<div class="col-3 col-md-1">
								...
								<h5 class="mb-3 mb-md-0">2,5 м</h5>
							</div>
							<div class="col-3 col-md-1">
							...
							<div class="col-3 col-md-1">
								...
								<h5 class="mb-3 mb-md-0">3,5 м</h5>
							</div>
							<div class="col-3 col-md-1">
							...
							<div class="col-3 col-md-1">
								...
								<h5 class="mb-3 mb-md-0">4,5 м</h5>
							</div>
							<div class="col-3 col-md-1">
						...
						<div class="row justify-content-center">
							<div class="col text-center" style="margin-top: 35px;">
								<input type="button" value="Назад" class="btn btn-corporate-color-outline-1"
									onclick="previousQuostion( '4-2' );">
								<input type="button" value="Далее" class="btn btn-danger" onclick="nextQuostion( '4-2' );">
							</div>
						</div>
					</div>
					...
					<div class="col-12" id="5-2" style="display: none;">
						<h5 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">4/6</span>Какое количество дверей Вы
							предполагаете?</h5>
						<div class="row justify-content-md-center mb-5">
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">1 дверь</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">2 двери</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">3 двери</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">4 двери</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">5 дверей</h5>
							</div>
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Более 5 дверей</h5>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col text-center" style="margin-top: 35px;">
								<input type="button" value="Назад" class="btn btn-corporate-color-outline-1"
									onclick="previousQuostion( '5-2' );">
								<input type="button" value="Далее" class="btn btn-danger" onclick="nextQuostion( '5-2' );">
							</div>
						</div>
					</div>
					...
					<div class="col-12" id="6-2" style="display: none;">
						<h5 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">5/6</span>Какой подарок Вы хотите
							получить в случае заказа?</h5>
						<div class="row justify-content-md-center mb-5">
							<div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Скидка 15%</h5>
							</div>
							<div class="col-6 col-md-2">
								<label class="option_item mb-3" for="answer-6-2-2">
									<input type="radio" id="answer-6-2-2" name="quostion-6-2" class="checkbox"
										value="Беспроцентная рассрочка на 6 месяцев">
									<div class="option_inner">
										<div class="shadow-wrapper">
											<div class="shadow-wrapper-decoration"></div>
										</div>
								...
								<h5 class="mb-3 mb-md-0">Беспроцентная рассрочка на 6 месяцев</h5>
							</div>
							<!--div class="col-6 col-md-2">
								...
								<h5 class="mb-3 mb-md-0">Бесплатная доставка</h5>
							</div-->
							<div class="col-6 col-md-2">
								<label class="option_item mb-3" for="answer-6-2-4">
									<input type="radio" id="answer-6-2-4" name="quostion-6-2" class="checkbox"
										value="Скидка 10% на заказ кухни в теченее года">
									<div class="option_inner">
										<div class="shadow-wrapper">
											<div class="shadow-wrapper-decoration"></div>
										</div>
								...
								<h5 class="mb-3 mb-md-0">Скидка 10% на заказ кухни в теченее года</h5>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col text-center" style="margin-top: 35px;">
								<input type="button" value="Назад" class="btn btn-corporate-color-outline-1"
									onclick="previousQuostion( '6-2' );">
								<input type="button" value="Далее" class="btn btn-danger" onclick="nextQuostion( '6-2' );">
							</div>
						</div>
					</div>

					<div class="col-12" id="7-2" style="display: none;">
						<h5 class="text-center mb-5"><span class="me-2" style="color: #A5A5A5;">6/6</span>Введите Ваши контакты</h5>
				...
				<!--div class="row">
					...
					<div class="col-lg-6 text-center">
						<img src="<?php echo get_template_directory_uri(); ?>/img/question-shkaf.png"  class="question-img img-fluid"/>
					</div>
				</div-->
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-lg-5">
								<div class="row">
									<div class="col-3 offset-md-1">
										<img src="<?php echo get_template_directory_uri(); ?>/img/ico/proizvodstvo.png" class="img-fluid" />
									</div>
									<div class="col-8">
									...
									<div class="col text-center preimushestvo">
										...
										<ul>
											<li>
												<img src="<?php echo get_template_directory_uri(); ?>/img/ico/list-ico.png" class="" />
							...
							<div class="col-lg-5 offset-lg-2">
								<div class="row">
									<div class="col-3 offset-md-1">
										<img src="<?php echo get_template_directory_uri(); ?>/img/ico/otnoshenie.png" class="img-fluid" />
									</div>
									<div class="col-8">
							...
							<div class="col-lg-6 offset-lg-3">
								<div class="row">
									<div class="col-3 offset-md-1">
										<img src="<?php echo get_template_directory_uri(); ?>/img/ico/garantii.png" class="img-fluid" />
									</div>
									<div class="col-8">
			...
			<div class="col-md-9">
				...
				<div class="row justify-content-center text-center text-md-start">
					<div class="col-md-7 mb-5 mb-md-0 text-center">
						...
						<!--p class="mb-5"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/yandex-logo.svg" alt="Yandex"></p>
						<p class="mb-5">
							<img src="<?php echo get_template_directory_uri(); ?>/img/ico/stars.svg" alt="Рейтинг фабрики «Гарантшкаф» в Яндекс">
			...
			<div class="col-md-9">
				...
				<div class="row">
					...
					<div class="col-lg-5 offset-lg-1 px-0 text-right order-1 order-lg-2">
						<img src="<?php echo get_template_directory_uri(); ?>/img/shkaf-kupe-img.jpg"
