                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-1">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/2-1.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-2">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/2-2.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-3">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/2-3.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-4">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/2-4.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-5">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/2-5.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-6">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/2-6.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-1">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/3-1.webp" style="width: 100%">
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-2">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/3-2.webp" style="width: 100%">
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-3">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/3-3.webp" style="width: 100%">
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-4">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/3-4.webp" style="width: 100%">
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-5">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/3-5.webp" style="width: 100%">
                                        </div>
                                    </label>
                                    <h6 class="quiz-section-h3 mb-4">Пока не знаю</h6>
                                </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-5-5">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/5-5.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-5-6">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/img/5-6.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                    ...
                                    <div class="col-6 col-sm-4 col-xl-3 mb-3">
                                        <label class="option_item" for="answer-7-4">
                                            <div class="d-flex quiz-chek gap-2 align-items-center">
                                                ...
                                                <img src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/ico/max-icons.svg" class="qize-feedback-icons">
...
<script type="module" src="<?php echo get_template_directory_uri(); ?>/template-parts/quiz/quize.js"></script>